...
namespace Grocery.App.ViewModels
{
    public partial class BoughtProductsViewModel : BaseViewModel
    {
        ...
        partial void OnSelectedProductChanged(Product? oldValue, Product newValue)
        {
            ...
            BoughtProductsList.Clear();// maakt de boughtProductsList leeg
            foreach(BoughtProducts boughtProduct in _boughtProductsService.Get(newValue.Id)) // Voegt items toe aan de lijst voor NewValueId
            {
